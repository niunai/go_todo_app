...
import (
	...
	"github.com/niunai/go_todo_app/clock"
	"github.com/niunai/go_todo_app/entity"
	"github.com/niunai/go_todo_app/store"
	"github.com/niunai/go_todo_app/testutil"
	"github.com/niunai/go_todo_app/testutil/fixture"
)
...
func TestJWTer_GetJWT(t *testing.T) {
	...
	want, err := jwt.NewBuilder().
		...
		Issuer(`github.com/niunai/go_todo_app`).
